...
//  download a resource
    def download(){
        DocumentResource resource = Resource.findById(params.id) // find resource
...
//  mark a resource reading item from a resource as read
    def markRead(){
        String msg = resourceService.read(session.user,params.int("id")) // calling read service
        println "---------->" + msg
...
//  rate a resource
    def rateResource(){
        String msg = resourceService.rate(session.user,params.int("id"),params.int("score")) // calling rate service
        println "---------->" + msg
